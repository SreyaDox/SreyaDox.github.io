...
scripting in Flash, and 3D animation in 3DS Max. I later completed an
M.Sc. in Information Technology (2001–2004).

Those two tracks, programming and design, came together in my first
job.
...
progressive disclosure and a more mature workflow. When I needed to
scale, I built in tests and validations. And I learned throughout from
